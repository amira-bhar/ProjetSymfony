...
class RecipeController extends AbstractController
{
    ...
    public function downloadPdf(Recipe $recipe, PdfService $pdfService): Response
    {
        ...
        // Generate the PDF
        $pdfContent = $pdfService->generateRecipePdf($recipe);

        // Create the response with PDF content
        $response = new Response($pdfContent);

        // Set the headers to download the PDF in the browser
        $response->headers->set('Content-Type', 'application/pdf');
        $response->headers->set('Content-Disposition', 'inline; filename="recipe_' . $recipe->getId() . '.pdf"');
